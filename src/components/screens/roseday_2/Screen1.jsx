...
export default function Screen1({ onNext, name }) {
    return (
        <motion.div
            ...
            >
                <img loading="lazy" src="/gifs/Roseday_1/Roseday_1.gif" className="w-40" alt="waving" />
            </motion.div>
            ...
            >
                <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">I have a little secret for {name}...</h1>
