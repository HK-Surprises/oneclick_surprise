        ...
        <motion.div
            ...
            {finished && (
                ...
                >
                    ...
                    >
                        <img src="/gifs/Roseday_1/Roseday_3.gif" className="w-60" alt="flower" />
                    </motion.div>
                    <motion.h2
                        initial={{ opacity: 0, y: 50, scale: 0.8 }}
                        animate={{ opacity: 1, y: 0, scale: 1 }}
                        transition={{ delay: 1, duration: 1, ease: "easeInOut" }}
                        className="text-3xl md:text-4xl font-semibold px-4 text-center text-white leading-tight tracking-wide will-change-transform">
